...
export default {
  ...
  methods: {
    ...
    onShortcutTouchMove(e) {
      ...
      let delta = Math.floor((this.touch.y2 - this.touch.y1) / ANCHOR_HIGHT)
    ...
    // 计算每个listGroup区间的高度并保存到listHeight中
    _calculateHeight() {
      this.listHeight = []
  ...
  watch: {
    ...
    // 当scrollY值发生变化时，判断该值落在哪个listGroup区间
    scrollY(newY) {
